...
[
    {
      "id": 1,
      "image": "https://i.ibb.co/cSQdg7tf/mango-min.jpg",
      "name": "Mango Tree",
    ...
    {
      "id": 2,
      "image": "https://i.ibb.co/WNbbx3rn/guava-min.jpg",
      "name": "Guava Tree",
    ...
    {
      "id": 3,
      "image": "https://i.ibb.co/xt98PwZq/jackfruit-min.jpg",
      "name": "Jackfruit Tree",
    ...
    {
      "id": 4,
      "image": "https://i.ibb.co/1YzsVWjm/Gulmohar-min.jpg",
      "name": "Gulmohar",
    ...
    {
      "id": 5,
      "image": "https://i.ibb.co/qY8qS7YN/champa-min.jpg",
      "name": "Champa",
    ...
    {
      "id": 6,
      "image": "https://i.ibb.co/MxPrt83c/Krishnachura-min.jpg",
      "name": "Krishnachura",
    ...
    {
      "id": 7,
      "image": "https://i.ibb.co/FkH6MRhR/banyan-min.jpg",
      "name": "Banyan Tree",
    ...
    {
      "id": 8,
      "image": "https://i.ibb.co/CKXhH7nP/neem-min.jpg",
      "name": "Neem Tree",
      "description": "A medicinal shade tree with powerful insect-repelling properties. Its leaves, bark, and seeds are widely used in traditional remedies.",
      "category": "Shade Tree",
      "price": 600
    },
    {
      "id": 9,
      "image": "https://i.ibb.co/svQdDjS8/rain-min.jpg",
      "name": "Rain Tree",
      "description": "A fast-growing tree with umbrella-like canopy and soft pink flowers. Perfect for roadside planting to provide cool shade.",
      "category": "Shade Tree",
      "price": 900
    },
    {
      "id": 10,
      "image": "https://i.ibb.co/50K7Cgv/amla-min.jpg",
      "name": "Amla Tree",
    ...
    {
      "id": 11,
      "image": "https://i.ibb.co/MxSDCxV4/arjun-min.jpg",
      "name": "Arjun Tree",
      "description": "A sturdy tree with bark known for its heart-strengthening properties. Valued in herbal medicine for cardiovascular health.",
      "category": "Medicinal Tree",
      "price": 700
    },
    {
      "id": 12,
      "image": "https://i.ibb.co/pB68Sz1g/bael-min.jpg",
      "name": "Bael Tree",
      "description": "A fruit tree whose pulp is used as a natural coolant and digestive aid. The fragrant flowers also attract bees and butterflies.",
      "category": "Medicinal Tree",
      "price": 500
    },
    {
      "id": 13,
      "image": "https://i.ibb.co/391CtLWD/teak-min.jpg",
      "name": "Teak",
    ...
    {
      "id": 14,
      "image": "https://i.ibb.co/QvGgW8Fb/mahogony-min.jpg",
      "name": "Mahogany",
      "description": "A premium timber tree producing richly colored, strong wood. Favored for fine furniture and interior paneling.",
      "category": "Timber Tree",
      "price": 2500
    },
    {
      "id": 15,
      "image": "https://i.ibb.co/Lz6BSq4Z/sal-min.jpg",
      "name": "Sal Tree",
    ...
    {
      "id": 16,
      "image": "https://i.ibb.co/fdYphDNS/pine-min.jpg",
      "name": "Pine",
    ...
    {
      "id": 17,
      "image": "https://i.ibb.co/YTJjYcGX/cypress-min.jpg",
      "name": "Cypress",
    ...
    {
      "id": 18,
      "image": "https://i.ibb.co/xSL9M8tg/fir-min.jpg",
      "name": "Fir",
      "description": "A conical evergreen tree ideal for ornamental gardens. Its wood is also used in light construction and paper making.",
      "category": "Evergreen Tree",
      "price": 1400
    },
    {
      "id": 19,
      "image": "https://i.ibb.co/x8gt87ks/bonsai-min.jpg",
      "name": "Bonsai",
      "description": "An artfully grown miniature tree cultivated in pots. Represents patience, harmony, and a connection to nature.",
      "category": "Ornamental Plant",
      "price": 800
    },
    {
      "id": 20,
      "image": "https://i.ibb.co/Y79mHSng/areca-palm-min.jpg",
      "name": "Areca Palm",
    ...
    {
      "id": 21,
      "image": "https://i.ibb.co/8gqbH5LC/fan-palm-min.jpg",
      "name": "Fan Palm",
    ...
    {
      "id": 22,
      "image": "https://i.ibb.co/xqFD0WyS/golden-bamboo-min.jpg",
      "name": "Golden Bamboo",
      "description": "A fast-growing bamboo variety with golden-yellow stems. Perfect for privacy hedges and eco-friendly construction.",
      "category": "Bamboo",
      "price": 700
    },
    {
      "id": 23,
      "image": "https://i.ibb.co/BKZ52h3q/black-bamboo-min.jpg",
      "name": "Black Bamboo",
    ...
    {
      "id": 24,
      "image": "https://i.ibb.co/FL3c30KJ/giant-bamboo-min.jpg",
      "name": "Giant Bamboo",
    ...
    {
      "id": 25,
      "image": "https://i.ibb.co/svtZJ7nw/money-plant-min.jpg",
      "name": "Money Plant",
    ...
    {
      "id": 26,
      "image": "https://i.ibb.co/Ngzp0tkJ/Bougainvillea-min.jpg",
      "name": "Bougainvillea",
    ...
    {
      "id": 27,
      "image": "https://i.ibb.co/4ZrDBFHC/passion-flower-min.jpg",
      "name": "Passion Flower",
    ...
    {
      "id": 28,
      "image": "https://i.ibb.co/VWNQPDMR/water-lily-min.jpg",
      "name": "Water Lily",
    ...
    {
      "id": 29,
      "image": "https://i.ibb.co/4g4J0Tkj/lotus-min.jpg",
      "name": "Lotus",
    ...
    {
      "id": 30,
      "image": "https://i.ibb.co/0jLycYdv/Water-Hyacinth-min.jpg",
      "name": "Water Hyacinth",
...
function renderProducts() {
  ...
  const productsToShow = plants.slice(0, 9);
  ...
  productsToShow.forEach(plant => {
    ...
    spinner.style.display = "none";}, 500);
}}
